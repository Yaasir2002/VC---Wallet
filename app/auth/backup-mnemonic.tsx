  ...
  async function loadMnemonic() {
    try {
      ...
      Alert.alert(
        ...
        'Recovery phrase belum tersedia. Silakan buat wallet ulang.',
        [
          {
            text: 'Kembali',
  ...
  if (loading) {
    return (
      <View style={styles.centerContainer}>
        ...
        <Text style={styles.loadingText}>Memuat recovery phrase...</Text>
      </View>
    );
  }
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Simpan 12 kata ini. Recovery phrase digunakan untuk memulihkan DID
            dan private key wallet kamu.
          </Text>
        </View>
        ...
        <View style={styles.warningCard}>
          ...
          <Text style={styles.warningText}>
            Jangan bagikan phrase ini kepada siapa pun. Jika hilang, wallet tidak
            bisa dipulihkan. Jika orang lain memilikinya, mereka dapat
            memulihkan identitas wallet kamu.
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  copyButtonText: { color: '#2563EB', fontSize: 12, fontWeight: '900' },
  wordGrid: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: 10,
  ...
  wordText: { color: '#111827', fontSize: 14, fontWeight: '900' },
  confirmRow: {
    backgroundColor: '#FFFFFF',
    borderRadius: 18,
    padding: 16,
